...
var Btn = function (_a) {
    ...
    return (react_1.default.createElement(core_1.Button, __assign({}, props),
        !loading && children,
        loading && react_1.default.createElement(core_1.CircularProgress, { color: loadingColor, size: 24 })));
};
exports.Btn = Btn;
